  ...
  return (
    <section className="relative pt-36 pb-20 px-6 max-w-7xl mx-auto text-center overflow-hidden">
      ...
      <p className=" text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-normal">
        Deploy asycnchronous miscroservices, orchestrate high-throughput APIs
        and streams live telementry across distibuted global environment with
        zero downtime
      </p>
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
        ...
        <a
          href="#architecture"
          className="w-full sm:w-auto bg-dark-card border border-dark-border hover:border-500/50 text-gray-200 px-8 py-3.5 rounded-xl font-bold text-sm transition-all"
        >
          {" "}
